      ...
      <div className="max-w-[1200px] text-center w-full flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 w-full max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            {/* Title Box */}
            <div className="w-full bg-white/[0.03] border border-white/5 rounded-xl py-8 px-4 mb-10 shadow-xl flex flex-col items-center">
              <h2 className="text-4xl md:text-5xl font-bold text-[#C5A880] mb-3 tracking-tight">Template AURA</h2>
