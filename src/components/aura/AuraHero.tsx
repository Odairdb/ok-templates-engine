...
export default function AuraHero({ initialNiche }: { initialNiche: string }) {
  ...
  return (
    <section className="relative w-full h-screen min-h-[700px] flex items-center overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 w-full relative z-10 flex flex-col pt-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start pl-4 lg:pl-10">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-lg text-white/90 font-sans leading-relaxed mb-10 max-w-md drop-shadow-md">
                {activeSlide.subtitle}
              </p>

              <div className="flex flex-wrap items-center gap-6">
                <a href="#agendar" className="px-8 py-4 bg-[#8B2626] hover:bg-[#6e1e1e] text-white rounded-full font-bold text-sm transition-all shadow-xl uppercase tracking-widest border border-white/10 backdrop-blur-sm">
                  Agendar Horário
                </a>
              </div>
            </motion.div>
