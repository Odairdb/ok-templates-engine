  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 flex items-center justify-between">
        ...
        <a href="#agendar" className="bg-[#C5A880] hover:bg-[#D4B58A] text-[#1A1A1A] font-black px-8 py-4 rounded-full text-xs uppercase tracking-[0.15em] transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(197,168,128,0.6)] shadow-[0_0_15px_rgba(197,168,128,0.3)] hidden sm:block">
          Agendar
        </a>
      </div>
    </motion.header>
